export const config = {
  ...
  CALLBACK_TEMPLATE_ID: "7H3qByegKy413cwY9G18Z0uWjyivGypBcrHecAC5ZI0",
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "*生日", "name": "大宝贝", "year": "2000", "date": "09-17", isShowAge: true},
    {"type": "*生日", "name": "狗子", "year": "2000", "date": "12-08", isShowAge: true},
    // {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
    // {"type": "生日", "name": "李四", "year": "1996", "date": "09-31", isShowAge: true},
    {"type": "节日", "name": "恋爱纪念日", "year": "2018", "date": "12-24"},
    // 你可以不断按格式往下增加
    // ...
  ],
  ...
  SLOT_LIST: [
    // 这样配置的话，就会每次发送这句话
    {"keyword": "encourage_oneself", contents: "久处不厌"},
    // 这样配置的话，就会每次随机选一句话发送
